...
public class AccountController {
    ...
    @FXML
    public TableView<TransactionRow> tableView;
    @FXML
    public TableColumn<TransactionRow, String> fromAddressCol;
    @FXML
    public TableColumn<TransactionRow, BigDecimal> amountCol;
    @FXML
    public TableColumn<TransactionRow, String> statusCol;
    @FXML
    Button gameBtn;
    ...
    public void initialize() {
        gameBtn.setOnMouseClicked((e) -> client.setGameScene());
...
//        try {
////			txs = client.player.getTransactions();
//        } catch (Exception e1) {
//            e1.printStackTrace();
//            return;
//        }
...
//        }
        ...
        Double balance;
        try {
            balance = client.player.getBalance();
        } catch (Exception e1) {
            e1.printStackTrace();
            return;
        }
